package com.wyuyc.shoppingmall.shoppingcart.activity;
...
import com.wyuyc.shoppingmall.app.MainActivity;
...
public class ShoppingCartActivity extends Activity implements View.OnClickListener {
    ...
    @OnClick({R.id.ib_shopcart_back, R.id.tv_shopcart_edit, R.id.btn_check_out, R.id.btn_delete, R.id.btn_collection,R.id.tv_empty_cart_tobuy})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_delete:
                ...
                adapter.checkAll();
                break;
            case R.id.tv_empty_cart_tobuy: //去逛逛
    ...
    private void showData() {
        ...
        List<GoodsBean> goodsBeanList = cartProvider.getDataFromLocal();
        if (goodsBeanList != null && goodsBeanList.size() > 0) {
            tvShopcartEdit.setVisibility(View.VISIBLE);
            llEmptyShopcart.setVisibility(View.GONE);
            adapter = new ShoppingCartAdapter(this, goodsBeanList, tvShopcartTotal, cartProvider, checkboxAll, cbAll);
